...
.head 1 +  Libraries
.head 2 -  ! /##### LS : 16/04/2007
.head 2 -  File Include: envvar.apl
.head 2 -  ! \##### LS : 16/04/2007
...
.head 4 -  Number: WM_WinIniChange	= 0x001A
.head 4 -  Number: WM_QUERYENDSESSION	= 0x0011
.head 4 -  Number: WM_QueryEndSession	= 0x0011
.head 4 -  !
...
.head 4 -  Number: ACT_RetrieveRO		= 11
.head 4 -  !
...
.head 4 -  File Name: c:\p_lib32\resource\MOVEUP.BMP
.head 3 +  Bitmap: resMoveDown
.head 4 -  File Name: c:\p_lib32\resource\MOVEDOWN.BMP
.head 3 +  Bitmap: resSortAsc
.head 4 -  File Name: c:\p_lib32\resource\SORTASC.BMP
.head 3 +  Bitmap: resSortDesc
.head 4 -  File Name: c:\p_lib32\resource\SORTDESC.BMP
.head 3 +  Bitmap: resRetrieve
.head 4 -  File Name: c:\p_lib32\resource\RETRIEVE.BMP
.head 3 +  Bitmap: resZoomIn
.head 4 -  File Name: c:\p_lib32\resource\ZOOMIN1.BMP
.head 2 +  Variables
...
.head 3 -  !
.head 3 -  !
.head 3 -  String: gsALoginPwd[ *,3 ]
.head 3 -  Number: gnRowFind
.head 3 -  String: gsStringFind
...
.head 5 -  Return lbOk
.head 3 +  Function: PalGetErrorSql
.head 4 -  Description:
.head 4 +  Returns
.head 5 -  Number:
.head 4 +  Parameters
...
.head 4 +  Actions
.head 5 -  Call SqlExtractArgs( wParam, lParam, lhSql, lnError, lnErrorPos )
.head 5 -  Return lnError
.head 3 +  Function: PalIdentSql
.head 4 -  Description: Connection à la DB
.head 4 -  Returns
.head 4 +  Parameters
.head 5 -  Sql Handle: prhSql
.head 5 -  String: psIdent
.head 4 -  Static Variables
.head 4 +  Local variables
.head 5 -  Boolean: lbOk
.head 4 +  Actions
.head 5 +  If SalStrLength( psIdent ) > 0
.head 6 -  Call SqlSetParameterAll( prhSql, 3024, 0, psIdent, FALSE )
...
.head 3 +  Function: PalDoubleBSlash
.head 4 -  Description: Double les \
.head 4 +  Returns
.head 5 -  String:
.head 4 +  Parameters
.head 5 -  String: psStr
...
.head 5 +  ! If ModifyMenuA (lhMainMenu, pnMainMenuItemPos, MF_ByPosition | MF_POPUP, SalWindowHandleToNumber( lhSubMenu ), psLanguageText)
.head 6 -  ! Call SalDrawMenuBar (phWndFrm)
.head 6 -  Return TRUE
.head 5 +  ! Else
.head 6 -  Return FALSE
.head 5 -  Set hMenu = VisMenuGetHandle( phWndFrm )
.head 5 -  ! Set hMenu = VisMenuGetPopupHandle( hMenu, pnMainMenuItemPos )
.head 5 -  Call VisMenuSetText( phWndFrm, hMenu, pnMainMenuItemPos, psLanguageText )
...
Cannot find menu item: ' || SalNumberToStrX( pnMainMenuItemPos, 0 ), 'Development error', MB_Ok | MB_IconExclamation )
.head 6 -  Return FALSE
.head 5 -  ! Set lnMenuItemID = GetMenuItemID (lhSubMenu, pnSubMenuItemPos)
...
.head 5 +  ! If ModifyMenuA (lhSubMenu, pnSubMenuItemPos, MF_ByPosition | MF_STRING, lnMenuItemID, psLanguageText)
.head 6 -  Call SalDrawMenuBar (phWndFrm)
.head 6 -  Return TRUE
.head 5 +  ! Else
.head 6 -  Return FALSE
.head 5 -  Set hMenu = VisMenuGetHandle( phWndFrm )
.head 5 -  Set hMenu = VisMenuGetPopupHandle( hMenu, pnMainMenuItemPos )
.head 5 -  Call VisMenuSetText( phWndFrm, hMenu, pnSubMenuItemPos, psLanguageText )
...
Cannot find menu item: ' || SalNumberToStrX( pnMainMenuItemPos, 0 ) || ','  || SalNumberToStrX( pnSubMenuItemPos, 0 ), 'Development error', MB_Ok | MB_IconExclamation )
.head 6 -  Return FALSE
.head 5 -  ! Set lnMenuItemID = GetMenuItemID (lhSubSubMenu, pnSubSubMenuItemPos)
.head 5 +  ! If lnMenuItemID = 0xFFFFFFFF
.head 6 -  Call SalMessageBox( 'Function SetSubSubMenuItemLanguageText:
...
.head 6 -  Return FALSE
.head 5 -  ! Wijzig de text van het menu item.
.head 5 +  ! If ModifyMenuA(lhSubSubMenu, pnSubSubMenuItemPos, MF_ByPosition | MF_STRING, lnMenuItemID, psLanguageText)
.head 6 -  Call SalDrawMenuBar (phWndFrm)
.head 6 -  Return TRUE
.head 5 +  ! Else
.head 6 -  Return FALSE
.head 5 -  Set hMenu = VisMenuGetHandle( phWndFrm )
.head 5 -  Set hMenu = VisMenuGetPopupHandle( hMenu, pnMainMenuItemPos )
.head 5 -  Set hMenu = VisMenuGetPopupHandle( hMenu, pnSubMenuItemPos )
.head 5 -  Call VisMenuSetText( phWndFrm, hMenu, pnSubSubMenuItemPos, psLanguageText )
...
.head 6 -  Return FALSE
.head 5 -  !
.head 5 -  ! Set lnMenuItemID = GetMenuItemID (lhSubSubSubMenu, pnSubSubSubMenuItemPos)
.head 5 +  ! If lnMenuItemID = 0xFFFFFFFF
.head 6 -  Call SalMessageBox( 'Function SetSubSubSubMenuItemLanguageText:
...
.head 6 -  Return FALSE
.head 5 -  ! Wijzig de text van het menu item.
.head 5 +  ! If ModifyMenuA (lhSubSubSubMenu, pnSubSubSubMenuItemPos, MF_ByPosition | MF_STRING, lnMenuItemID, psLanguageText)
.head 6 -  Call SalDrawMenuBar (phWndFrm)
.head 6 -  Return TRUE
.head 5 +  ! Else
.head 6 -  Return FALSE
...
.head 5 -  Set hMenu = VisMenuGetPopupHandle( hMenu, pnMainMenuItemPos )
.head 5 -  Set hMenu = VisMenuGetPopupHandle( hMenu, pnSubMenuItemPos )
.head 5 -  Set hMenu = VisMenuGetPopupHandle( hMenu, pnSubSubMenuItemPos )
.head 5 -  Call VisMenuSetText( phWndFrm, hMenu, pnSubSubSubMenuItemPos, psLanguageText )
...
.head 5 -  String: s3
.head 4 +  Actions
.head 5 -  ! Set s1 = SqlDatabase
.head 5 -  ! Set s2 = SqlUser
.head 5 -  ! Set s3 = SqlPassword
...
.head 6 -  ! /##### LS : 01/02/2007 : suite à différents problèmes en clientèle, pour tester
.head 6 -  ! Call SqlSetLockTimeout( phSqlParm, 10 )
.head 6 -  ! \##### LS : 01/02/2007 : suite à différents problèmes en clientèle, pour tester
.head 6 -  Call SqlCommit( phSqlParm )
.head 6 -  ! Set SqlDatabase = s1
.head 6 -  ! Set SqlUser = s2
.head 6 -  ! Set SqlPassword = s3
.head 6 -  Return TRUE
.head 5 +  Else
...
.head 4 -  Static Variables
.head 4 +  Local variables
.head 5 -  Long String: lsSqlError
.head 4 +  Actions
.head 5 -  ! /##### LS : 13/04/2007
.head 5 -  Set lsSqlError = SqlGetLastStatement(  )
.head 5 -  Set gsErrorSqlStmt = SqlGetLastStatement(  )
.head 5 -  ! \##### LS : 13/04/2007
...
.head 8 +  If wh != hWndNULL
.head 9 -  Call SalEnableWindow( wh )
.head 9 -  Call SalSendMsg( wh, 0x00CF, 0, 0 )
.head 7 -  Break
...
.head 3 -  !
.head 3 -  !
.head 3 +  Function: SetDFEnhancement
.head 4 -  Description:
.head 4 +  Returns
.head 5 -  Boolean:
.head 4 +  Parameters
.head 5 -  Window Handle: pwhDF
.head 5 -  Number: pnEnh
.head 4 -  Static Variables
.head 4 +  Local variables
...
.head 5 -  Boolean: bOk
.head 4 +  Actions
.head 5 -  Set bOk = SalFontGet( pwhDF, sFontName, nFontSize, nEnh )
.head 5 +  If bOk
.head 6 -  Set bOk = SalFontSet( pwhDF, sFontName, nFontSize, pnEnh )
.head 5 -  Return bOk
.head 3 +  Function: GetDFEnhancement
.head 4 -  Description:
.head 4 +  Returns
.head 5 -  Boolean:
.head 4 +  Parameters
.head 5 -  Window Handle: pwhDF
.head 5 -  Receive Number: pnEnh
.head 4 -  Static Variables
.head 4 +  Local variables
.head 5 -  String: sFontName
.head 5 -  Number: nFontSize
...
.head 5 -  Boolean: bOk
.head 4 +  Actions
.head 5 -  Set bOk = SalFontGet( pwhDF, sFontName, nFontSize, pnEnh )
.head 5 -  Return bOk
.head 3 -  !
.head 3 -  !
.head 3 -  !
...
.head 3 -  ! !
.head 3 -  ! !
.head 3 +  Function: PalGetTmpDir
.head 4 -  Description: Fournit un répertoire temporaire. La fonction recherche dans la table APPL_PARM le paramètre 'PATHTMP', sinon utilise la paramètre de la fonction
.head 4 +  Returns
.head 5 -  String:
.head 4 +  Parameters
.head 5 -  String: psDefRep
.head 4 -  Static Variables
.head 4 +  Local variables
.head 5 -  Boolean: bOk
.head 5 -  String: s1
.head 5 -  Number: n
.head 4 +  Actions
.head 5 +  If not PalGetApplParm( 'PATHTMP', s1 )
.head 6 -  Set s1 = psDefRep
.head 5 -  Set s1 = ExpandEnvironmentStrings( s1 )
.head 5 +  If SalStrRightX( s1, 1 ) != '\\'
.head 6 -  Set s1 = s1 || '\\'
.head 5 -  Set n = VisDosMakeAllDir( s1 )
.head 5 +  Select Case n
.head 6 -  Case VTERR_AccessDenied
.head 6 +  Case VTERR_WriteProtected
.head 7 -  Set s1 = ''
.head 7 -  Break
.head 6 -  Case VTERR_Ok
.head 6 +  Default
.head 7 -  Break
.head 5 +  ! If ( n != VTERR_WriteProtected )  and ( n !
.head 6 -  Set s1 = ''
.head 5 -  Return s1
.head 3 -  ! !
.head 3 -  ! !
...
.head 5 -  Set str = ComputerName || str
.head 5 -  Return str
.head 3 +  Function: PalInputQuery
.head 4 -  Description:
.head 4 +  Returns
.head 5 -  Boolean:
.head 4 +  Parameters
.head 5 -  Window Handle: hWndParent
.head 5 -  String: ACaption
.head 5 -  String: Aprompt
.head 5 -  Receive String: Value
.head 4 -  Static Variables
.head 4 +  Local variables
.head 5 -  Window Handle: whInput
.head 5 -  String: s
.head 5 -  Boolean: b
.head 4 +  Actions
.head 5 -  Set b = SalModalDialog(  dlgInputQuery, hWndForm, ACaption, Aprompt, s )
.head 5 +  If b
.head 6 -  Set Value = s
.head 5 -  Return b
.head 3 -  !
.head 3 -  ! /##### LS : 13/04/2007
.head 3 +  Function: PalGetDBVersion
.head 4 -  Description:
.head 4 +  Returns
.head 5 -  String:
.head 4 +  Parameters
...
.head 5 -  String: s
.head 4 +  Actions
.head 5 -  Call SqlGetParameter( phsql, DBP_VERSION, n, s )
.head 5 -  Return s
.head 3 -  ! \##### LS : 13/04/2007
.head 3 -  !
.head 3 -  !
...
.head 3 -  !
.head 3 -  !
.head 3 -  ! /##### LS : 17/04/2007
.head 3 +  Function: PalgetIsolationLevel
.head 4 -  Description:
.head 4 +  Returns
.head 5 -  String:
.head 4 +  Parameters
...
.head 5 -  Number: nTmp
.head 4 +  Actions
.head 5 -  Call SqlGetParameterAll( phSql, 3001, nTmp, sTmp, FALSE )
.head 5 -  Return sTmp
.head 3 -  ! \##### LS : 17/04/2007
.head 3 -  !
.head 2 +  Named Menus
...
.head 5 -  Menu Item Name:
.head 4 -  Menu Separator
.head 4 +  Menu Item: &Effacer
.head 5 -  Resource Id: 23922
.head 5 -  Keyboard Accelerator: (none)
.head 5 -  Status Text:
.head 5 +  Menu Settings
.head 6 -  Enabled when:
...
.head 5 -  Menu Item Name:
.head 4 -  Menu Separator
.head 4 +  Popup Menu: &Rechercher
.head 5 -  Resource Id: 22502
.head 5 -  Enabled when:
.head 5 -  Status Text:
.head 5 -  Menu Item Name:
.head 5 +  Menu Item: &Mot
.head 6 -  Resource Id: 22503
...
.head 7 -  Checked when:
.head 6 +  Menu Actions
.head 7 +  If PalInputQuery( SalParentWindow( gwhTrackPopupMenu ), "Search", "String : ", gsStringFind )
.head 8 -  ! Call gwhTrackPopupMenu.clsCTblDynSql.SearchString( hWndNULL, gsStringFind, gnRowFind )
.head 8 +  If gnRowFind = -1
.head 9 -  Set gnRowFind = 0
.head 8 -  Set gnRowFind = VisTblFindString( gwhTrackPopupMenu, gnRowFind, hWndNULL, gsStringFind )
.head 8 +  If gnRowFind > -1
.head 9 -  Call SalTblSetFocusRow( gwhTrackPopupMenu, gnRowFind )
.head 8 +  Else
...
.head 7 +  If bControl and  inAnneePiv and ( inAnneePiv > SalDateYear( MyValue ) )
...
.head 7 -  Set i = nMin
.head 7 +  While i <= nMax
.head 8 -  ! /##### : LS : 08/02/2007
.head 8 +  If not ( ( nMin = nMax ) and ( __TabsTranslations[ i, gnLanguage ] = "" ) )
.head 9 -  Call picTabs.SetLabel( i, __TabsTranslations[ i, gnLanguage ], FALSE )
.head 8 -  ! \##### : LS : 08/02/2007
.head 8 -  Set i = i + 1
...
.head 5 -  Background Color: Default
.head 5 -  Resizable?
.head 5 -  Vertical Scroll?
.head 5 -  Horizontal Scroll?
.head 4 -  Next Class Child Key: 1
.head 4 -  List in Tool Palette? Yes
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
...
.head 8 -  Return lhWndWindowHandle
.head 7 +  Else
...
.head 7 -  Set hWnd = iExistingWndMasterList.OpenWindow(psWindowName, phWndMDI, iWndInfoListOfMdi, pnWndParmArr)
.head 7 -  Call LockWindowUpdate( hWndNULL)
...
.head 5 -  !
.head 5 -  !
.head 5 -  String: __sOldIsoLev
.head 4 +  Functions
.head 5 -  !
.head 5 -  ! PUBLIC
.head 5 -  !
.head 5 -  ! /#### LS : 13/04/2007
.head 5 +  Function: SetReadOnly
.head 6 -  Description:
.head 6 -  Returns
.head 6 +  Parameters
.head 7 -  Boolean: pbOk
...
.head 6 +  Actions
.head 7 +  If pbOk 
.head 8 +  If __sOldIsoLev = ''
.head 9 -  Set __sOldIsoLev = PalgetIsolationLevel( ihSqlSelect )
.head 8 -  Call SqlSetIsolationLevel( ihSqlSelect, 'RO' )
.head 7 +  Else
.head 8 -  ! Call SqlSetIsolationLevel( ihSqlSelect, 'RL' )
.head 8 -  Call SqlSetIsolationLevel( ihSqlSelect, __sOldIsoLev )
.head 8 -  Set __sOldIsoLev = ''
.head 5 -  ! \#### LS : 13/04/2007
...
.head 5 -  ! /#### LS : 22/002/2007
.head 5 +  Function: GetSqlSelectWhere
.head 6 -  Description:
.head 6 +  Returns
.head 7 -  String:
.head 6 -  Parameters
...
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Return isSqlSelectWhere
.head 5 +  Function: GetSqlSelectColumns
.head 6 -  Description:
.head 6 +  Returns
.head 7 -  String:
.head 6 -  Parameters
...
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Return isSqlSelectColumns
...
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Return isSqlSelectOrderBy
.head 5 +  Function: GetSqlSelectTables
.head 6 -  Description:
.head 6 +  Returns
.head 7 -  String:
.head 6 -  Parameters
...
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Return isSqlSelectTables
.head 5 +  Function: GetSqlSelectWhereEqual
.head 6 -  Description:
.head 6 +  Returns
.head 7 -  String:
.head 6 -  Parameters
...
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Return isSqlSelectWhereEqual
.head 5 -  ! \#### LS : 22/002/2007
.head 5 -  !
...
.head 7 -  Call SqlSetIsolationLevel( ihSqlModify, 'RL' )
...
.head 9 -  Set prnRow = -1
.head 9 -  Return FALSE
.head 5 +  Function: SearchDateTime
.head 6 -  Description: Fonction de recherche d'une ligne dans la table.
...
.head 6 +  Parameters
.head 7 -  Window Handle: pwhColumn
.head 7 -  Date/Time: pdtValue
.head 7 -  Receive Number: prnRow
.head 6 -  Static Variables
.head 6 -  Local variables
.head 6 +  Actions
.head 7 +  If pdtValue = DATETIME_Null
.head 8 -  Return FALSE
.head 7 +  Else
.head 8 +  If prnRow <= -1
.head 9 -  Set __wnRow = 0
.head 8 +  Else
.head 9 -  Set __wnRow = prnRow + 1
.head 8 -  Set __wnRow = VisTblFindDateTime( hWndItem, __wnRow, pwhColumn, pdtValue )
.head 8 +  If __wnRow > -1
.head 9 -  ! Call SalTblSetFocusRow( hWndItem, wnRow )
.head 9 -  ! Call SalTblSetContext( hWndItem, wnRow )
.head 9 -  Set prnRow = __wnRow
...
.head 8 +  Else
.head 9 -  Set __wnRow = prnRow + 1
.head 8 -  Set __wnRow = VisTblFindNumber( hWndItem, __wnRow, pwhColumn, pnValue )
.head 8 +  If __wnRow > -1
.head 9 -  ! Call SalTblSetFocusRow( hWndItem, wnRow )
.head 9 -  ! Call SalTblSetContext( hWndItem, wnRow )
.head 9 -  Set prnRow = __wnRow
...
.head 7 +  If SqlDatabase != '' 
.head 8 +  When SqlError
.head 9 -  Return FALSE
.head 8 -  Return SqlConnect ( chSql )
.head 7 +  Else
.head 8 -  Return FALSE
...
.head 8 -  Set i = i + 1
.head 8 +  If i <= nMax
.head 9 -  Call SalSetWindowText( whWnd, __GroupboxTranslations[i,gnLanguage] )
...
.head 3 -  ActiveX:
.head 3 -  Check Box:
.head 3 -  Child Table: clsBaseCTblMaster
...
.head 6 -  Set sPwd = dfPassword
.head 6 +  If wnMin <= wnMax
.head 7 -  Set i = wnMin
.head 7 +  While i <= wnMax
.head 8 +  If SalStrUpperX( dfUser ) = SalStrUpperX( gsALoginPwd[i,0] )
.head 9 -  Set gsALoginPwd[i,2] = sPwd
.head 9 -  Set sPwd = gsALoginPwd[i,1]
.head 9 -  Break
.head 8 -  Set i = i + 1
.head 6 +  If wbConnect
.head 7 -  ! Call CStructFreeFarMem( nGlobalAlloc )
.head 7 +  If SqlConnection( ghSqlMain, dfDatabase, dfUser, sPwd )
.head 8 -  Call VisWaitCursor( FALSE )
...
.head 6 +  If not SalIsNull( dfUser )
...
.head 4 +  Message Actions
.head 5 +  On SAM_Click
.head 6 +  If SalFileOpen( fh, "inscom.txt", OF_Exist )
.head 7 +  If SalModalDialog( __dlgRechINS, hWndForm, rpsIns )
.head 8 -  Set dfDatabase = dfDatabase || rpsIns
.head 3 -  ! \##### : 23/04/2007
.head 2 -  Functions
.head 2 +  Window Parameters
...
.head 3 -  !
.head 3 -  ! /##### : 23/04/2007
.head 3 -  Boolean: bFileExist
.head 3 -  File Handle: fh
.head 3 -  String: rpsIns
.head 3 -  ! \##### : 23/04/2007
.head 2 +  Message Actions
.head 3 +  On SAM_CreateComplete
...
.head 4 -  Call SalArrayGetLowerBound( gsALoginPwd, 1, wnMin )
.head 4 -  Call SalArrayGetUpperBound( gsALoginPwd, 1, wnMax )
.head 3 +  On SAM_Create
...
.head 4 -  Font Size: Default
.head 4 -  Font Enhancement: Default
.head 4 -  Picture File Name: ENVELOPE.bmp
.head 4 -  Picture Transparent Color: None
.head 4 -  Image Style: Single
.head 4 -  Text Color: Default
.head 4 -  Background Color: Default
...
.head 4 +  Message Actions
.head 5 +  On SAM_Click
.head 6 +  If ghMailSlotHandle
.head 7 -  Call MailslotDestroy( ghMailSlotHandle )
.head 6 -  Call SalQuit(  )
.head 3 +  Pushbutton: pb2
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 6 -  Call SalQuit( )
.head 3 +  On SAM_Close
.head 4 +  If SalModalDialog( dlgGetPwd, hWndForm, VisStrSubstitute( psPwd, '
', '' ) ) = TRUE
...
.head 2 -  Class:
.head 2 -  Property Template: C:\p_lib32\langue\qo_lang32.exe,frmPropertiesLanguage,,,N,N
.head 2 -  Class DLL Name:
.head 2 -  Title:
.head 2 -  Icon File:
.head 2 -  Accessories Enabled? No
...
.head 2 -  Window Variables
.head 2 -  Message Actions
.head 1 +  Dialog Box: dlgInputQuery
.head 2 -  Class:
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title:
...
.head 3 -  Contents
.head 2 +  Contents
.head 3 -  Background Text: Prompt
.head 4 -  Resource Id: 22504
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class:
.head 4 -  Window Location and Size
...
.head 2 -  Functions
.head 2 +  Window Parameters
.head 3 -  String: ACaption
.head 3 -  String: APrompt
.head 3 -  Receive String: Value
.head 2 -  Window Variables
.head 2 +  Message Actions
.head 3 +  On SAM_Close
.head 4 -  Call SalEndDialog( hWndForm, FALSE )
.head 3 +  On SAM_Create
.head 4 -  Call SalSetWindowLabelText( df1, APrompt )
.head 4 -  Call SalSetWindowText( hWndForm, APrompt )
.head 1 +  Dialog Box: __dlgRechINS
.head 2 -  Class:
.head 2 -  Property Template:
.head 2 -  Class DLL Name:
.head 2 -  Title: Recherche INS
.head 2 -  Accessories Enabled? No
.head 2 -  Visible? Yes
.head 2 -  Display Settings
.head 3 -  Display Style? Default
...
.head 5 +  On SAM_AnyEdit
.head 6 -  Set wnRow = -1
.head 6 -  Call SalSetDefButton( pbGoto )
.head 3 +  Pushbutton: pbGoto
.data INHERITPROPS
0000: 0100
.enddata
.data CLASSPROPS
...
.head 4 -  Font Size: Class Default
.head 4 -  Font Enhancement: Class Default
.head 4 -  Picture File Name: \P_LIB32\RESOURCE\GLASS.BMP
.head 4 -  Picture Transparent Color: Class Default
.head 4 -  Image Style: Class Default
.head 4 -  Text Color: Class Default
.head 4 -  Background Color: Class Default
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 -  Call SalPicSet( hWndItem, resZoomIn, PIC_FormatBitmap )
.head 6 -  Set wnRow = 0
.head 5 +  On SAM_Click
.head 6 +  ! If not SalIsNull( dfFindGoto )
.head 7 +  If wnRow = -1
.head 8 -  Set wnRow = 0
.head 7 -  ! Set wnRow = VisTblFindString( ctblGestionAjustInterne, wnRow, ctblGestionAjustInterne.colArtArticleStr, dfFindGoto || '%' )
.head 7 -  Set wnRow = VisTblFindString( ctblFCompteFin, wnRow, hWndNULL, dfFindGoto || '%' )
.head 7 +  If wnRow > -1
.head 8 -  Call SalTblSetFocusRow( ctblFCompteFin, wnRow )
.head 8 -  Call SalTblSetContext( ctblFCompteFin, wnRow )
.head 8 -  Set wnRow = wnRow + 1
.head 7 +  Else
.head 8 -  Call SalMessageBeep( MB_Ok )
.head 8 -  Call PalMessageBox( 'Eind van het zoek', 'Fin de la recherche', '', '', MB_Ok )
.head 6 +  If not SalIsNull( dfFindGoto )
.head 7 -  Call tbl1.SearchString( hWndNULL, dfFindGoto, wnRow )
.head 7 +  If wnRow > -1
.head 8 -  Call SalTblSetFocusRow( tbl1, wnRow )
.head 8 -  Call SalTblSetContext( tbl1, wnRow )
.head 8 -  ! Set wnRow = wnRow + 1
.head 7 +  Else
.head 8 -  Call SalMessageBeep( MB_Ok )
.head 8 -  Call PalMessageBox( 'Eind van het zoek', 'Fin de la recherche', '', '', MB_Ok )
...
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class: clsBaseCTblMaster
.head 4 -  Property Template:
.head 4 -  Class DLL Name:
.head 4 -  Display Settings
.head 5 -  Window Location and Size
...
.head 4 +  Message Actions
.head 5 +  On SAM_Create
.head 6 +  If SalFileOpen( fh, 'inscom.txt', OF_Read | OF_Text )
.head 7 +  While SalFileGetStr( fh, s, 255 )
.head 8 -  Set n = SalStrTokenize( s, "	", "	", a )
.head 8 -  Set nRow= SalTblInsertRow( tbl1, TBL_MaxRow )
.head 8 -  Call SalTblSetContext( tbl1, nRow )
.head 8 -  Set tbl1.colIns = a[0]
.head 8 -  Set s = SalStrMidX( a[1], 1, SalStrLength( a[1] ) - 2 )
.head 8 -  Set tbl1.colLib = s
.head 8 -  Set s = SalStrMidX( a[2], 1, SalStrLength( a[2] ) - 2 )
.head 8 -  Set tbl1.colCP = s
.head 8 -  Call SalTblSetRowFlags( tbl1, nRow, ROW_New, FALSE )
.head 7 -  Call SalFileClose( fh )
.head 5 -  On SAM_CreateComplete
.head 5 +  On SAM_DoubleClick
.head 6 -  Call SalSendMsg( pb2, SAM_Click, wParam, lParam )
.head 3 +  Pushbutton: pb2
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
.head 4 -  Class:
...
.head 4 +  Message Actions
.head 5 +  On SAM_Click
.head 6 -  Set rpsNoIns = tbl1.colIns
.head 6 -  Call SalEndDialog( hWndForm, TRUE )
.head 3 +  Pushbutton: pb3
.head 4 -  Class Child Ref Key: 0
.head 4 -  Class ChildKey: 0
...
.head 2 -  Functions
.head 2 +  Window Parameters
.head 3 -  Receive String: rpsNoIns
.head 2 +  Window Variables
.head 3 -  Number: wnRow
.head 2 +  Message Actions
.head 3 +  On SAM_Create
