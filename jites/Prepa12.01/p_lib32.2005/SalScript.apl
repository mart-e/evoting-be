...
.head 2 +  Variables
.head 3 -  ! -------------------------------------------------------
.head 3 -  ! SalExecScript global static variables
.head 3 -  ! -------------------------------------------------------
.head 3 -  ! Number: nTemp1
.head 3 -  ! String: strTemp1
.head 3 -  ! Date/Time: dtTemp1
.head 3 -  ! Number: intTemp1
.head 3 -  ! String: sTemp1
.head 3 -  ! Long String: lsTemp1
.head 3 -  ! Date/Time: dTemp1
.head 3 -  ! Window Handle: hWndTemp1
.head 3 -  ! File Handle: fTemp1
.head 3 -  ! Sql Handle: SqlTemp1
.head 3 -  ! Boolean: bTemp1
.head 3 -  !
.head 3 -  ! Number: nTemp2
.head 3 -  ! String: strTemp2
.head 3 -  ! Date/Time: dtTemp2
.head 3 -  ! Number: intTemp2
.head 3 -  ! String: sTemp2
.head 3 -  ! Long String: lsTemp2
.head 3 -  ! Date/Time: dTemp2
.head 3 -  ! Window Handle: hWndTemp2
.head 3 -  ! File Handle: fTemp2
.head 3 -  ! Sql Handle: SqlTemp2
.head 3 -  ! Boolean: bTemp2
.head 3 -  !
.head 3 -  ! Number: nTemp3
.head 3 -  ! String: strTemp3
.head 3 -  ! Date/Time: dtTemp3
.head 3 -  ! Number: intTemp3
.head 3 -  ! String: sTemp3
.head 3 -  ! Long String: lsTemp3
.head 3 -  ! Date/Time: dTemp3
.head 3 -  ! Window Handle: hWndTemp3
.head 3 -  ! File Handle: fTemp3
.head 3 -  ! Sql Handle: SqlTemp3
.head 3 -  ! Boolean: bTemp3
.head 3 -  !
.head 3 -  ! Number: anTemp[*]
.head 3 -  ! String: astrTemp[*]
.head 3 -  ! Date/Time: adtTemp[*]
.head 3 -  ! Number: aintTemp[*]
.head 3 -  ! String: asTemp[*]
.head 3 -  ! Long String: alsTemp[*]
.head 3 -  ! Date/Time: adTemp[*]
.head 3 -  ! Window Handle: ahWndTemp[*]
.head 3 -  ! File Handle: afTemp[*]
.head 3 -  ! Sql Handle: aSqlTemp[*]
.head 3 -  ! Boolean: abTemp[*]
.head 3 -  !
...
.head 4 -  Description: 	Select Case
	EndSelectCase
	Case
	EndCase
	Default
...
.head 7 -  !
.head 7 -  ! 'LongString' ??
.head 7 +  Else If sWord = 'long string:' or sWord = 'longstring:'
.head 8 -  Set lsLine = VisStrTrim( SalStrRightX( lsLine, SalStrLength( lsLine ) - SalStrLength( sWord ) ) )
.head 8 -  Call ExecScriptAddVar ( DT_LongString, lsLine )
.head 7 -  !
.head 7 -  ! 'WindowHandle' ??
.head 7 +  Else If sWord = 'window handle:' or sWord = 'window:'
.head 8 -  Set lsLine = VisStrTrim( SalStrRightX( lsLine, SalStrLength( lsLine ) - SalStrLength( sWord ) ) )
.head 8 -  Call ExecScriptAddVar ( DT_WindowHandle, lsLine )
.head 7 -  !
.head 7 -  ! 'FileHandle' ??
.head 7 +  Else If sWord = 'file handle:' or sWord = 'file:'
.head 8 -  Set lsLine = VisStrTrim( SalStrRightX( lsLine, SalStrLength( lsLine ) - SalStrLength( sWord ) ) )
.head 8 -  Call ExecScriptAddVar ( DT_FileHandle, lsLine )
.head 7 -  !
.head 7 -  ! 'SqlHandle' ??
.head 7 +  Else If sWord = 'sql handle:' or sWord = 'sql:'
.head 8 -  Set lsLine = VisStrTrim( SalStrRightX( lsLine, SalStrLength( lsLine ) - SalStrLength( sWord ) ) )
