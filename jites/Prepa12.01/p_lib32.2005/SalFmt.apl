...
.enddata
		...
		Variables
		Internal Functions
			Function: SalFmtAnsiToOem
				Description: Makes an in-place conversion from the ANSI
				...
				Local variables
				Actions
					Call CharToOemA( sTemp, sTemp )
					Return sTemp
			Function: SalFmtOemToAnsi
				Description: Makes an in-place conversion from the OEM
